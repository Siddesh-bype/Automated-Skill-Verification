    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                enqueueSnackbar('Account created! Wallet generated.', { variant: 'success' });
                navigate('/');
            } else {
    ...
    return (
        <div className="min-h-screen bg-surface-950 flex items-center justify-center p-6">
            <div className="card-workspace max-w-md w-full p-8 border-surface-700/60 bg-surface-900/50 backdrop-blur-xl">
                <h2 className="text-3xl font-bold text-center mb-2 text-surface-50">Create Account</h2>
                <p className="text-center text-surface-400 mb-8">Get a free Algorand wallet instantly.</p>
